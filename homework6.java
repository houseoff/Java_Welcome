...
public class homework6 {
    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            choise = InputChecker.checkInput(FormPatterns.getMainMenuFormat(), mismatchMsg);
            cls    = true;
            switch (choise) {
                case 1:
                ...
                case 2:
                    while (true) {
                        ...
                        choise = InputChecker.checkInput(FormPatterns.getFilterMenuFormat(), mismatchMsg);
                        if (choise != 5) {
                            ...
                            if (choise == 1) {
                                iPattern = InputChecker.checkInput("Ошибка ввода. Повторите ввод: ");
                                ...
                                sPattern = InputChecker.uncheckedInput();
